export const CUSTOMER_REVIEWS = [
  {
    ...
    description: `Marie was excellent, very prompt, clear and friendly. Would
    recommend for first home buyers who want to be kept in the loop and
    shown all the steps.`,
    authorName: "Jake Curtis",
    totalStars: 5,
    id: 1,
  },
  {
